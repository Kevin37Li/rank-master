"""
Django settings for rankMaster project.
...
SECRET_KEY = 'django-insecure-)xee!w8la*77x7=w&3#3(jjf(&3udr1u(wh=-lobebxdy_rn_d'
...
WSGI_APPLICATION = 'rankMaster.wsgi.application'
...
# set customizing serializers for djoser
DJOSER = {
    'SERIALIZERS': {
